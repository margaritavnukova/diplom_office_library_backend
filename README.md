...
В данном репозитории содержится исходный код бэкенда дипломного проекта. Фронтенд проекта лежит в репозитории по адресу github.com/margaritavnukova/diplom_office_library_backend
